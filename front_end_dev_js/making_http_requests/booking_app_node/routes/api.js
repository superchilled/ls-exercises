...
/**
 * @api {get} /staff_members Retreives all available staff memebers  
 * @apiGroup Staff
 * 
...
/**
 * @api {get} /students Retreives all registered students
 * @apiGroup Student
 * 
...
/**
 * @api {get} /schedules Retreives all available schedules  
 * @apiGroup Schedule
 * 
...
/**
 * @api {get} /schedules/:staff_id Retreives all available schedules for a given staff_id
 * @apiGroup Schedule
 * 
 ...
 *     HTTP/1.1 404 Not Found
 *     'Student does not exists; booking_sequence: {sequence}'
 */
...
/**
 * @api {put} /bookings/:booking_id Student cancles a booking
 * @apiGroup Student
 * 
